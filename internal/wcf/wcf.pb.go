...
type WxMsg struct {
	...
	Ts            uint32                 `protobuf:"varint,5,opt,name=ts,proto3" json:"ts,omitempty"`                          // 时间帧
...
type Verification struct {
	...
	Scene         int64                  `protobuf:"varint,3,opt,name=scene,proto3" json:"scene,omitempty"` // 添加方式：17 名片，30 扫码 2421814416 神秘方式
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Verification) GetScene() int64 {
	if x != nil {
		return x.Scene
	}
	return 0
...
var file_wcf_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x05, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x22, 0x3a, 0x0a, 0x0a, 0x4d, 0x65, 0x6d,
...
var file_wcf_proto_goTypes = []any{
...
func file_wcf_proto_init() {
	...
	file_wcf_proto_msgTypes[0].OneofWrappers = []any{
		(*Request_Empty)(nil),
		(*Request_Str)(nil),
		(*Request_Txt)(nil),
		(*Request_File)(nil),
	...
	file_wcf_proto_msgTypes[1].OneofWrappers = []any{
		(*Response_Status)(nil),
		(*Response_Str)(nil),
		(*Response_Wxmsg)(nil),
		(*Response_Types)(nil),
